...
int main() {
    double sourceVoltage = 20.0; // Source voltage in volts
    double loadResistance = 1000.0; // Load resistance in ohms
    double resistor1 = 330.0;      // Resistor 1 in ohms
    double resistor2 = 330.0;      // Resistor 2 in ohms
